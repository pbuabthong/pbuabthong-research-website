...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('data/research')) fs.mkdirSync('data/research', { recursive: true })
    const filePath = `data/research/${fileName ? fileName : 'untitled'}.${
    ...
    fs.writeFile(filePath, frontMatter, { flag: 'wx' }, (err) => {
      if (err) {
        ...
        console.log(`Research post generated successfully at ${filePath}`)
      }
    })
  })
  .catch((error) => {
